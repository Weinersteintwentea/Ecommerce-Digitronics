...
<div class="panel panel-blue"> <!-- panel panel-blue Start -->
...
<div class="col-lg-3 col-md-6"> <!-- col-lg-3 col-md-6 Start -->
<div class="panel panel-indigo"> <!-- panel panel-red Start -->
<div class="panel-heading"> <!-- panel-heading Start -->
<div class="row"> <!-- panel-heading row Start -->
<div class="col-xs-3"> <!-- col-xs-3 Start -->
...
<div class="col-lg-3 col-md-6"> <!-- col-lg-3 col-md-6 Start -->
<div class="panel panel-grey"> <!-- panel panel-red Start -->
<div class="panel-heading"> <!-- panel-heading Start -->
<div class="row"> <!-- panel-heading row Start -->
<div class="col-xs-3"> <!-- col-xs-3 Start -->
...
<div class="col-lg-3 col-md-6"> <!-- col-lg-3 col-md-6 Start -->
<div class="panel panel-brown"> <!-- panel panel-red Start -->
<div class="panel-heading"> <!-- panel-heading Start -->
<div class="row"> <!-- panel-heading row Start -->
<div class="col-xs-3"> <!-- col-xs-3 Start -->
...
<span class="thumb-info-type"><b class="hi"><?php echo $admin_job; ?></b></span>
...
<i class="fa fa-street-view"></i> <span>Country: </span> <?php echo $admin_country; ?> <br>
<i class="fa fa-address-card"></i> <span>Contact: </span> <?php echo $admin_contact; ?> <br>
