...
if (isset($_POST['submit'])) {
	...
	$receiverEmail="tejasgorivale14@gmail.com";
	mail($receiverEmail,$senderName,$senderSubject,$senderMassage,$senderEmail);
	//Customer mail
	$email=$_POST['email'];
	$subject="Welcome to Digitronics";
	$msg="I shall get you soon, thanks for sending mail";
	$from="tejasgorivale14@gmail.com";
	mail($email,$subject,$msg,$from);
	echo "<h2 align='center'>Your mail sent</h2>";
	echo "<script>alert('Thank You for giving your feedback we would ping you soon');</script>";
}
?>